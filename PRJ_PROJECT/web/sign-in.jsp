                            ...
                            <div class="row">
                                <div class="col-lg-8 col-11 mx-auto">
                                    ...
                                    <form role="form" method="post" action="login">
                                        ...
                                        <div class="fxt-transformY-50 fxt-transition-delay-2" style="margin-top: 10px; display: flex; justify-content: space-between">
                                            <div>
                                                <input ${reMem == null ? "" : "checked"} id="remember" type="checkbox" name="remember" style="margin-top: 10px ;margin-right: 6px; width: 15px; height: 15px">
                                                <label style="font-size: 15px" for="remember">Remember me</label>
                                            </div>                                            
                                            <div>
                                                <a style="color: black" href="#" class="switcher-text2">Forgot Password</a>
                                            </div>
                                        </div>
                                        ...
                                        <button type="submit" class="btn custom-btn form-control mt-4 mb-3">
                                            Sign in
                                                ...
                                                <p class="text-center">Don’t have an account? <a href="sign-up.jsp" style="font-weight: bold" class="signin-button">Create One</a></p>
